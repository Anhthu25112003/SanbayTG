...
map.getView().fit([-19769488.970866, -17679875.138081, 19186172.233098, 20103428.922057], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">BẢN ĐỒ SÂN BAY TRÊN THẾ GIỚI</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (21 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Bảng xếp hạng sân bay';
            }
